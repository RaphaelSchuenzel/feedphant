        ...
        <div id="landing-inner" class="w-100">
            ...
            <section id="boards" class="w-100 bdc-background-shade">
                ...
                <div v-if="boards && boards.length > 0" class="row">
                    <nuxt-link v-for="board in boards" v-bind:key="board.title" :to=" '/board/' + board.name " class="board bc-background bdc-background-shade h-bc-background-shade h-bdc-primary h-bs-m col">
